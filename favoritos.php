...
<head>
  ...
  <title>Kuroinku | Favoritos</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small><a href="favoritos.php" style="color: black">Mangas Favoritos</a></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-home"></i> Kuroinku</a></li>
        <li class="active"><a href="favoritos.php">Mangas Favoritos</a></li>
      </ol>
    </section>
              ...
              <div class="modal-body"><!--#Body modal comentar-->
                ...
                if(isset($_POST['btnsubir'])){
                  ...
                  if(is_uploaded_file($rfoto)){
                    ...
                    $subir_query = "INSERT INTO manga (nombre,genero,temporada,creador,fecha_pub,portada,id_usuario,publicado) values ('$nombre','$genero','$temporada','$creador', '$fecha_pub', '$img_nombre', '$userpublic','0')";
                    ...
                    if ($subir_result) {
                      ...
                      <?php                      
                        ...
                        ?>
                      <script>console.log('Error al subir el manga');</script>
                      <?php
                    } 
                  }else{
                        ?>
